...
const pdfGenerator = {
    ...
    async generateContractPDFAsBase64(contract) {
        ...
        try {
            ...
            // Testo timbro
            doc.setFontSize(7);
            doc.setTextColor(0, 51, 102); // Blu
            doc.text("PANNELLI TERMICI S.r.l.", stampX + stampWidth / 2, stampY + 6, { align: 'center' });
            doc.text("Via dell'Alpo, 27", stampX + stampWidth / 2, stampY + 10, { align: 'center' });
            doc.text("64026 Roseto Degli Abruzzi (TE)", stampX + stampWidth / 2, stampY + 14, { align: 'center' });
            doc.text("C.F./P.IVA 00454730235", stampX + stampWidth / 2, stampY + 18, { align: 'center' });
